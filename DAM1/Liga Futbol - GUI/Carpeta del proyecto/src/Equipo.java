...
public class Equipo {
    ...
    public Equipo(String nombre, String sede, String pais, String estadio, int añoFundacion, int mesFundacion, int diaFundacion, ImageIcon icono){
        this.nombre = nombre; 
        this.sede = sede;
        this.pais = pais;
    ...
    public ArrayList<Equipo> crearEquipos(){
        ...
        equipos.add(new Equipo("Real Madrid", "Madrid", "España", "Santiago Bernabéu", 1902, 3, 6, new ImageIcon("media/realMadrid.png")));
        equipos.add(new Equipo("Juventus", "Turín", "Italia", "Alliazn", 1897, 11, 1,new ImageIcon("media/juventus.png")));
        equipos.add(new Equipo("Manchester City", "Manchester", "Inglaterra", "Etihad", 1880, 11, 23, new ImageIcon("media/manchesterCity.png")));
        equipos.add(new Equipo("Atlético de Madrid", "Madrid", "España", "Metropolitano", 1903, 4, 26, new ImageIcon("media/atleticoMadrid.png")));
        equipos.add(new Equipo("Al-Nassr", "Riad", "Arabia Saudita", "Mrsool Park", 1955, 11, 24, new ImageIcon("media/alNassr.png")));
        equipos.add(new Equipo("Barcelona", "Barcelona", "España", "Camp Nou", 1899, 11, 29, new ImageIcon("media/barcelona.png")));
        equipos.add(new Equipo("Paris Saint-Germain", "París", "Francia", "Parque de los Príncipes", 1970, 8, 12, new ImageIcon("media/parisSaint.png")));
        equipos.add(new Equipo("Albacete Balompié", "Albacete", "España", "Carlos Belmonte", 1960, 9, 9, new ImageIcon("media/albacete.png")));
